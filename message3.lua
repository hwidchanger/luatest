...
local function handle_mouse()
    ...
    -- Используем стандартный метод проверки кнопки
    if input.IsButtonDown(1) then  -- 1 = ЛКМ
...
local function RegisterCallbacks()
		...
		my_draw_callback_ref2 = callbacks.Register("Draw", handle_mouse)
		my_draw_callback_ref3 = callbacks.Register("Draw", draw_speclist_header)
